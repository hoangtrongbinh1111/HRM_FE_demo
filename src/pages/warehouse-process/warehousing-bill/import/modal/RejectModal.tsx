...
import { RepairReject } from '@/services/apis/repair.api';
import { WarehousingBillReject } from '@/services/apis/warehousing-bill.api';
...
const RejectModal = ({ ...props }: Props) => {
    ...
    const handleRepair = (param: any) => {
        WarehousingBillReject({ id: router.query.id, comment: param.comment }).then(() => {
            handleCancel();
