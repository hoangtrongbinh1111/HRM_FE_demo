...
const AddNewTask = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(t('add_calendar')));
    });
    ...
    const handleTask = (value: any) => {
        ...
        createTask({
            ...
            .then(() => {
                showMessage(`${t('add_calendar_success')}`, 'success');
                router.push('/hrm/calendar-department');
            })
            .catch((err) => {
