...
import { RequestAdvancePaymentReject } from '@/services/apis/request-advance-payment.api';
...
const RejectModal = ({ ...props }: Props) => {
    ...
    const handleProposal = (param: any) => {
        setIsReject(true);
        RequestAdvancePaymentReject({ id: router.query.id, comment: param.comment }).then(() => {
            handleCancel();
