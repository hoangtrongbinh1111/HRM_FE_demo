...
const DetailDuty = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(`${t('detail_duty')}`));
    });
    //get data
        ...
        <div>
            ...
            <div className="p-5">
                <ul className="flex space-x-2 rtl:space-x-reverse mb-6">
                    ...
                    <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                        <span>{t('detail_duty')}</span>
                    </li>
                </ul>
                <div className="header-page-bottom mb-4 flex justify-between pb-4">
                    <h1 className="page-title">{t('detail_duty')}</h1>
                    <div className='flex' style={{ alignItems: "center" }}>
                        <RBACWrapper permissionKey={['position:update']} type={'AND'}>

                            {
                                <Link href={`/hrm/duty/${router?.query.id}?page=${router?.query?.page}&perPage=${router?.query?.perPage}`}>
                        ...
                        <Form className="space-y-5" >
                            <div className="flex justify-between gap-5">
                                <div className="mb-5 w-1/2">
                                    ...
                                    <Field disabled autoComplete="off" name="name" type="text" id="name" placeholder={`${t('enter_name_duty')}`} className="form-input" />
                                ...
                                <div className="mb-5 w-1/2">
                                    ...
                                    <Field disabled autoComplete="off" name="code" type="text" id="code" placeholder={`${t('enter_code_duty')}`} className="form-input" />
                                    ...
                                    <div className="flex" style={{ alignItems: 'center', marginTop: '13px' }}>
                                        <label style={{ marginBottom: 0, marginRight: '10px' }}>
                                            <Field
                                                ...
                                                className="form-checkbox disable rounded-full"
                            ...
                            <div className='flex justify-between gap-5'>
                                ...
                                <div className="w-1/2">
                                    ...
                                    <Field autoComplete="off" disabled name="level" type="number" id="level" placeholder={`${t('level')}`} className="form-input" />
