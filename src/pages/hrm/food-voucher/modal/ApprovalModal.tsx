...
import { FoodVoucherForward } from '@/services/apis/food-voucher.api';
...
const ApprovalModal = ({ ...props }: Props) => {
    ...
    const handleProposal = (param: any) => {
        ...
        FoodVoucherForward({ id: id_, ...dataSubmit }).then(() => {
            if (props.sign === 2) {
    ...
    const handleCancel = () => {
        ...
        if (props.createdId) {
            router.push(`/hrm/food-voucher/${props.createdId}`)
        }
    };
