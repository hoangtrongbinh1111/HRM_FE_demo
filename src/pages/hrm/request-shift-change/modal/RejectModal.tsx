...
import { RequestShiftChangeReject } from '@/services/apis/request-shift-change.api';
...
const RejectModal = ({ ...props }: Props) => {
    ...
    const handleProposal = (param: any) => {
        setIsReject(true);
        RequestShiftChangeReject({ id: router.query.id, comment: param.comment, sign: 4 }).then(() => {
            handleCancel();
