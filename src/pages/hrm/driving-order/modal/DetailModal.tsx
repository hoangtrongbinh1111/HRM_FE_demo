...
import { AddDrivingOrderDetail, EditDrivingOrderDetail } from '@/services/apis/driving-order.api';
...
const DetailModal = ({ ...props }: Props) => {
    ...
    const handleDrivingOrder = (param: any) => {
        if (Number(router.query.id)) {
            ...
            if (props?.data) {
                EditDrivingOrderDetail({ id: router.query.id, detailId: props?.data?.id, ...query }).then(() => {
                    handleCancel();
                ...
                AddDrivingOrderDetail({ id: router.query.id, ...query }).then(() => {
                    handleCancel();
    ...
    const handleCancel = () => {
        ...
        props.drivingOrderDetailMutate();
        // props.setData();
    };
                                    ...
                                    <div className="pl-10 pr-10 p-5">
                                        <Formik
                                            ...
                                            onSubmit={async (values, { resetForm }) => {
                                                await handleDrivingOrder(values)
                                                // resetForm()
                                            }}
                                            enableReinitialize
                                        >
