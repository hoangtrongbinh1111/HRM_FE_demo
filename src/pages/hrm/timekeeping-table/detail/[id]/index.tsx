...
import { roundDecimal } from '@/utils/commons';
...
const DetailPage = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(`${t('detail_timekeeping_staff')}`));
    });
        ...
        <div>
            ...
            <ul className="flex space-x-2 rtl:space-x-reverse mb-6">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <Link href="/hrm/timekeeping-table" className="text-primary hover:underline">
                        <span>{t('timekeeping_table')}</span>
                    </Link>
                    ...
                    <div className="rounded">
                        ...
                        <div className={`${active.includes(2) ? 'custom-content-accordion' : ''}`}>
                            <AnimateHeight duration={300} height={active.includes(2) ? 'auto' : 0}>
                                <div className="p-4">
                                    <div className="datatables" id="timekeeping-table-detail">
                                        <DataTable
                                            highlightOnHover
