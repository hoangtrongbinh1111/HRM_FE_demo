...
import { TravelPaperForward, TravelPaperPending } from '@/services/apis/travel-paper.api';
...
const ApprovalModal = ({ ...props }: Props) => {
    ...
    const handleProposal = (param: any) => {
        ...
        TravelPaperForward({ id: id_, ...dataSubmit }).then(() => {
    ...
    const handleCancel = () => {
        ...
        if (props.createdId) {
            router.push(`/hrm/travel-paper/${props.createdId}`)
        }
    };
