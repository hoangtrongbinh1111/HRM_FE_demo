                                                    ...
                                                    <div className="upload__image-wrapper">
                                                        <div className="upload__image-wrapper">
                                                            <div
                                                                ...
                                                                style={{ cursor: 'pointer', width: '200px', height: '250px', marginLeft: '50px', border: imageList.length !== 0 || detail?.avatar ? 'none' : '2px #BABABA dashed' }}
                                                                onClick={onImageUpload}
                                                            >
                                                                <div style={{ marginTop: imageList.length === 0 && detail?.avatar ? '100px' : '100px' }}>
                                                                    {imageList.length === 0 ? (
                                                                        <>
                                                                            {detail?.avatar ? (
                                                                                <img
                                                                                    src={`${process.env.NEXT_PUBLIC_BE_URL}${detail?.avatar}`}
                                                                                    alt="img"
                                                                                    style={{ width: '200px', height: '250px', borderRadius: '50px' }}
                                                                                />
                                                                            ) : (
                                                                                <>
                                                                                    <img src="/assets/images/uploadfile.png" className="icon_upload" style={{ marginTop: '20px' }} alt="upload"></img>
                                                                                    {t('upload')}
                                                                                </>
                                                                            )}
                                                                        </>
